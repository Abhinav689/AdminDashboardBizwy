...
import Topbar from "../Sidebars/Topbar2";
import './styles.css';
      ...
      <Box display="flex" flexDirection="row" sx={{ mt: "64px", backgroundColor: "#141b2d", height: "100vh" }}>
        ...
        >
          ...
          {activeStep === 0 && (
           ...
           <Step2 formData={formData} handleSave={updateFormData} />
</div>
                           ...
                           {activeStep === 2 && (
            <>
           <Step3 formData={formData} handleSave={updateFormData} />
</>
                           ...
                           {activeStep === 3 && (
            <>
           <Step4 formData={formData} handleSave={updateFormData} />
</>
                           ...
                           {activeStep === 4 && (
            <div style={{marginTop:"-10rem"}}>
           <Step5 formData={formData} handleSave={updateFormData} />
</div>
                           ...
                           {activeStep === 5 && (
            <>
           <Step6 formData={formData} handleSave={updateFormData} />
</>
                           ...
                           {activeStep === 6 && (
            <>
           <Step7 formData={formData} handleSave={updateFormData} />
</>
